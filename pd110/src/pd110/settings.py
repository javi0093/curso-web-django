...
SECRET_KEY = 'django-insecure-apacr!u@-x(-ca+7a0bcr$og2_2w2^qopg=y79bv&wb&&2ptnv'
...
#lo siguiente es para pasar de login a la página de inicio, lo hago para que no me salte el error hasta que haga la página de perfil
